...
<body>
  ...
  <header id="header" style="background-color: #5A56E9;" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="POST" action="./pesquisa-ong.php">
        <input type="text" name="txtNomeOng" placeholder="Id ou Nome" title="Enter search keyword">
  ...
  <main id="main" class="main">
    ...
    <div class="container-fluid">
      <div id="container">
        <h1>Lista de ONGs</h1>
        <form class="d-flex" role="search" action="./gera-relatorio-ong.php" method="post">
          <button class="btn btn-outline-success" type="submit">Gerar Relatório</button>
        </form>
        <form class="d-flex" role="search" action="./gera-pdf-ong.php" method="post">
            <button class="btn btn-outline-success" type="submit">Gerar PDF</button>
          </form>
        <table class="table" style="margin-top: 5%;">
          ...
          <tbody>
            ...
            <?php foreach ($listaong as $key => $listar) { ?>
              <tr>
                <td><?php echo $idOng = $listar['idong'] ?></td>
                <td><?php echo $nomeOng = $listar['nomeong'] ?></td>
                <td><?php echo $dtNasc = $listar['datanascong'] ?></td>
                <td><?php echo $cepOng = $listar['cepong'] ?></td>
                <td><?php echo $estadoOng = $listar['estadoong'] ?></td>
                <td><?php echo $cidadeOng = $listar['cidadeong'] ?></td>
                <td><?php echo $bairroOng = $listar['bairroong'] ?></td>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="./editar-user-ong.php" method="post">
    ...
    <div class="modal fade" id="excluir" tabindex="-1" role="dialog" aria-labelledby="editar" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <form action="./decisao-excluir-ong.php" method="post">
              <button type="button" class="btn btn-primary" data-dismiss="modal">CANCELAR</button>
              <button type="submit" class="btn btn-danger" name="idOng" id="idOng" value="<?php echo $idOng ?>">EXCLUIR</button>
            </form>
          </div>
        </div>
      </div>
