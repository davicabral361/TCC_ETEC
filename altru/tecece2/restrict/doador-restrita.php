      ...
      <div id="container">
        <table>
          ...
          <form class="d-flex" role="search" action="./gera-relatorio-doador.php" method="post">
            <button class="btn btn-outline-success" type="submit">Gerar Excel</button>
          </form>
          <form class="d-flex" role="search" action="./gera-pdf-doador.php" method="post">
          ...
          <tbody>
            <?php foreach ($listadoador as $key => $listar) { ?>
              <tr>
