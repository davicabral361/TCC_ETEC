...
try {
  ...
  $pesquisaDoacao = $doacao->pesquisaDoacao($idDoacao);
} catch (Exception $e) {
  echo $e->getMessage();
}
?>
    ...
    <header id="header" style="background-color: #5A56E9;" class="header fixed-top d-flex align-items-center">
      ...
      <div class="search-bar">
        <form class="search-form d-flex align-items-center" method="POST" action="./pesquisa-doacao.php">
          <input type="text" name="iddoacao" placeholder="Search" title="Enter search keyword">
      ...
      <div class="container-fluid">
        <div id="container">
          <table>
            ...
            <tbody>
              <?php foreach ($pesquisaDoacao as $key => $listar) { ?>
                <tr>
