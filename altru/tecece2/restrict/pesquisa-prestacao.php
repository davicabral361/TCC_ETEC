...
try {
    ...
    $pesquisaPrestacao = $prestacao->pesquisaPrestacao($nomeOng, $dtInicio, $dtTermino);
} catch (Exception $e) {
    echo $e->getMessage();
}
?>
        ...
        <div class="container-fluid">
            <div id="container">
                <table>
                    ...
                    <tbody>
                        <?php foreach ($pesquisaPrestacao as $key => $listar) { ?>
                            <tr>
                                ...
                                <!-- <td>
                                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editar" name="editar" id="editar" data-whatever="<?php echo $idPrestacaoContasOng ?>" data-whateverong="<?php echo $nomeOng ?>" data-whateverdesc="<?php echo $descProdutosRecebidos ?>" data-whateverdata="<?php echo $dataRecebimento ?>" data-whateverquantidade="<?php echo $quantidadeItensRecebido ?>">
                                        EDITAR
                                    </button>
                                </td>
                                            ...
                                            <div class="modal-body">
                                                <form action="./editar-user-prestacao.php" method="post">
                                                    <div class="form-group">
                                                        <label for="recipient-id" class="col-form-label">COLOCAR FOTOS</label>
                                                        <br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" id="recipient-data" name="dataEditar" readonly>
                                                    </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary" data-dismiss="modal">CANCELAR</button>
