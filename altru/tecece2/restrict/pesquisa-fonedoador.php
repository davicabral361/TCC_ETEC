...
try {
    ...
    $listafonedoador = $telefonedoador->pesquisaTelefoneDoador($pesquisa);
} catch (Exception $e) {
    echo $e->getMessage();
}
?>
...
<body>
    ...
    <header id="header" style="background-color: #5A56E9;" class="header fixed-top d-flex align-items-center">
        ...
        <div class="search-bar">
            <form class="search-form d-flex align-items-center" method="POST" action="./pesquisa-fonedoador.php">
                <input type="text" name="query" placeholder="Número ou Doador" title="Enter search keyword">
                <button type="submit" title="Search"><i class="bi bi-search"></i></button>
            </form>
        </div><!-- End Search Bar -->


        <form class="d-flex" role="search" action="./gera-relatorio-fonedoador.php" method="post">
            ...
            <div id="container">
                ...
                <table class="table" style="margin-top: 5%;">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($listafonedoador as $key => $listar) { ?>
                            <tr>


                                <td><?php echo $idTelefonedoador = $listar['idtelefonedoador'] ?></td>
                                <td><?php echo $telefonedoador = $listar['telefonedoador'] ?></td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="./editar-user-fonedoador.php" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="recipient-doador" name="doadorEditar" disabled="">
                                                        </div>
                                                </div>
                                    ...
                                    <div class="modal fade" id="excluir" tabindex="-1" role="dialog" aria-labelledby="editar" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="./decisao-excluir-fonedoador.php" method="post">
                                                        <button type="button" class="btn btn-primary" data-dismiss="modal">CANCELAR</button>
                                                        <button type="submit" class="btn btn-danger" name="idtelefone" id="idtelefone" value="<?php echo $idTelefoneDoador ?>">EXCLUIR</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strdoador><span>Dashboard</span></strdoador>. All Rights Reserved
        </div>
        <div class="credits">
    ...
    <script type="text/javascript">
        $('#editar').on('show.bs.modal', function(event) {
            ...
            var recipientDoador = button.data('whateverdoador')
        ...
        $('#excluir').on('show.bs.modal', function(event) {
            ...
            modal.find('#idtelefone').val(recipient)
