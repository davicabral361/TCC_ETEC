...
try {
  ...
  $listaResposta = $respostausuario->listar();
} catch (Exception $e) {
  echo $e->getMessage();
}
?>
    ...
    <div class="container-fluid">
      <div id="container">
        <table>
          ...
          <tbody>
            <?php foreach ($listaResposta as $key => $listar) { ?>
              <tr>
          ...
          <div class="modal-body">
            <form action="./editar-user-resposta.php" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="recipient-doador" name="doadorEditar" readonly>
              </div>
              <div class="form-group">
