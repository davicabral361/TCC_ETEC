...
try {
    ...
    $pesquisa = $_POST['fone-ong'];

    $listafoneong = $telefoneOng->pesquisaTelefoneOng($pesquisa);
} catch (Exception $e) {
    echo $e->getMessage();
}
?>
...
<body>
    ...
    <header id="header" style="background-color: #5A56E9;" class="header fixed-top d-flex align-items-center">
        ...
        <div class="search-bar">
            <form class="search-form d-flex align-items-center" method="POST" action="./pesquisa-fone-ong.php">
                <input type="text" name="fone-ong" placeholder="Número ou ONG" title="Enter search keyword">
                <button type="submit" title="Search"><i class="bi bi-search"></i></button>
            </form>
        </div><!-- End Search Bar -->

        <form class="d-flex" role="search" action="./gera-relatorio-foneong.php" method="post">
            ...
            <div id="container">
                ...
                <table class="table" style="margin-top: 5%;">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($listafoneong as $key => $listar) { ?>
                            <tr>


                                <td><?php echo $idTelefoneOng = $listar['idtelefoneong'] ?></td>
                                <td><?php echo $telefoneOng = $listar['telefoneong'] ?></td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="./editar-user-foneong.php" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="recipient-ong" name="ongEditar" disabled="">
                                                    </div>
                                            </div>
                                ...
                                <div class="modal fade" id="excluir" tabindex="-1" role="dialog" aria-labelledby="editar" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="./decisao-excluir-foneong.php" method="post">
                                                    <button type="button" class="btn btn-primary" data-dismiss="modal">CANCELAR</button>
                                                    <button type="submit" class="btn btn-danger" name="idtelefone" id="idtelefone" value="<?php echo $idTelefoneOng ?>">EXCLUIR</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
